                ...
                <div id="checklist" class="h-auto w-3/5 m-4 medi-client rounded-md medi_list" style="background-color:#C9DFEC; height:675px; overflow: hidden;">
                    <div class="flex flex-row rounded-md">
                        ...
                        <?php  foreach($consult as $uncheck): if($uncheck->day == $today && $uncheck->checked == 1){ ?>
                            <form action="uncheck1.php?id=<?= $uncheck->client_id;?>&date=<?= $uncheck->day;?>" method="post">
                                <div class="flex flex-row h-auto w-90 m-4 medi-client rounded-md border-red-200">
                                    <div class="flex flex-col w-16 bg-white rounded-md mr-2">
                                                    ...
                                                    <td class="p-1">
                                                        <?php 
                                                            ...
                                                            if($uncheck->checked == 1 && $consu->insured == 1){
                                                                ...
                                                                echo '<b>Tot:</b>(<b style="color: red;">'.$consu->cons_u_p.'</b> Rwf)';
                                                            }else
                                                            {
                                                    ...
                                                    <td>
                                                        <?php 
                                                            ...
                                                            if($uncheck->checked == 1 && $labo->insured == 1){$lab= count($uncheck->items->laboratoire);
                                                                echo '(<b >'.$lab.'</b>)(<b>Tot: </b><b style="color: red;">'.$labo->lab_u_p.'</b> Rwf) '; 
                                                            }else
                                                            {
                                                                echo '(Tot:<b style="color: red;">0</b> Rwf)';
                                                            }
                                                    ...
                                                    <td class="p-1">
                                                        <?php 
                                                            ...
                                                            if($uncheck->checked == 1 && $meds->insured == 1){$med=count($uncheck->items->medicines);
                                                                echo '(<b>'.$med.'</b>)(<b>Tot:</b></b><b style="color: red;">'.$meds->med_u_p.'</b> Rwf)';
                                                            }else
                                                            {
                                                                echo '(Tot:<b style="color: red;">0</b> Rwf)';
                                                            }
                                                    ...
                                                    <td class="">
                                                        <?php 
                                                            ...
                                                            if($uncheck->checked == 1 && $consoms->insured == 1){$conso= count($uncheck->items->consommables);
                                                                echo'(<b class="text-md ml-2">'.$conso.' </b>)(<b>Tot: </b><b style="color: red;">'.$consoms->conso_u_p.'</b> Rwf)';
                                                            }else
                                                            {
                                                                echo '(Tot:<b style="color: red;">0</b> Rwf)';
                                                            }
                                                    ...
                                                    <td>
                                                        <?php 
                                                            ...
                                                            if($uncheck->checked == 1 && $soins->insured == 1){$soin=count($uncheck->items->soins);
                                                                echo'(<b class="text-md ml-2">'.$soin.'(<b>Tot: </b><b style="color: red;">'.$soins->act_med_u_p.'</b> Rwf) ';
                                                            }else
                                                            {
                                                                echo '(Tot:<b style="color: red;">0</b> Rwf)';
                                                            }
                                                    ...
                                                    <td class="">
                                                        <?php 
                                                            ...
                                                            if($uncheck->checked == 1 && $hosp->insured == 1){$hosps= count($uncheck->items->hospitalisation);
                                                                echo'(<b class="text-md ml-2">'.$hosps.'(<b>Tot: </b><b style="color: red;">'.$hosp->hosp_u_p.'</b> Rwf)';
                                                            }else
                                                            {
                                                                echo '(Tot:<b style="color: red;">0</b> Rwf)';
                                                            }
